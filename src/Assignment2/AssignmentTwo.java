...
public class AssignmentTwo {
    ...
    private static final Double DEFAULT_INIT_TEMP = Math.pow(10, 10);
    private static final Double DEFAULT_COOLING_FACTOR = 1.0;
    ...
    public static void main(String[] args) throws IOException {
        ...
        String path = "src/Assignment2/data/RandomTit.arff"; // Path to data file. Change if necessary
